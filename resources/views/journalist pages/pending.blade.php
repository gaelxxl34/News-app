...
@section('content')
        ...
        <nav class="navbar navbar-expand px-2 border-bottom d-flex justify-content-between">
            ...
            <h5  style="color: black">Pending Articles!</h5>
        ...
        <div class="card custom-card">
            ...
            <div class="card-header d-flex align-items-center border-0">
                <img src="../assets/img/user.jpg" alt="Journalist Avatar" class="rounded-circle" style="width: 50px; height: 50px; object-fit: cover;">
                <div class="ms-3">
            ...
            <img src="../assets/img/news-700x435-2.jpg" alt="Article Picture" class="card-img-top border-0">
            ...
            <div class="card-footer d-flex justify-content-between align-items-center border-0">
                ...
                <a href="{{ route('journalist.full-pending-article') }}" class="btn btn-sm btn-primary">Read more <i class="fas fa-arrow-right"></i></a>
